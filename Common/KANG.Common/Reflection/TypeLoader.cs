...
namespace KANG.Common.Reflection
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Get the type list from assembly file by using Assembly.Load(byte[]).
        /// </summary>
        /// <param name="assemblyFile">The name or path of the file that contains the manifest of the assembly.</param>
        /// <returns>Array of System.Type object.</returns>
        public static Type[] Load(string assemblyFile)
        {
        ...
        /// <summary>
        /// Get the type list from assembly file by using Assembly.LoadFrom(string).
        /// </summary>
        /// <param name="assemblyFile">The name or path of the file that contains the manifest of the assembly.</param>
        /// <returns>Array of System.Type object.</returns>
        public static Type[] LoadFrom(string assemblyFile)
        {
            if (string.IsNullOrEmpty(assemblyFile))
            {
                throw new ArgumentNullException("assemblyFile");
        ...
        /// <summary>
        /// Gets the System.Type object with the specified name from assembly file by using Assembly.LoadFrom(string).
        /// </summary>
        /// <param name="assemblyFile">The name or path of the file that contains the manifest of the assembly.</param>
        /// <param name="typeFullName">The full name of the type.</param>
        /// <param name="ignoreCase">true to ignore the case of the type name; otherwise, false.</param>
