...
namespace KANG.Distributed.Session {
    public class RedisSessionProvider: SessionStateStoreProviderBase {
        ...
        private readonly ConfigurationOptions options = new ConfigurationOptions {
            AllowAdmin = true,
            EndPoints = { new IPEndPoint(IPAddress.Parse(ConfigurationManager.AppSettings["RedisServer"]), 6379) },
            Password = ""
        };
